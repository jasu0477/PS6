...
const BookingCard = ({ vendor }) => {
  // Ensure vendor exists and provide fallback values
  const { name, jobType, chargePerHour, image,  rating, city, languages } = vendor || {};
      ...
      <div className="card-body p-6">
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-shrink-0 flex justify-center">
            <img 
              src={image || "https://placehold.co/200x200/252836/e2e8f0?text=Vendor"} 
              alt={name || "Vendor"} 
              className="w-24 h-24 rounded-lg object-cover" 
            />
          </div>
          <div className="flex-grow space-y-2">
            <h2 className="text-xl font-semibold">{name || "Vendor Name"}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-1">
              <div className="flex items-center">
                ...
                <span>{jobType || "Service Type"}</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="font-medium text-accent">{chargePerHour || "Price"}</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span>{languages ? languages.join(", ") : "English, Hindi"}</span>
              </div>
            </div>
          </div>
        </div>
