    ...
    <div className="min-h-screen bg-base-200">
      ...
      <div className="container mx-auto p-8">
        ...
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto bg-base-300 shadow-lg p-8 rounded-lg space-y-6">
          ...
          <div>
            <label className="block text-xl font-semibold">Language <span className="text-red-500">*</span></label>
            <select name="language" value={vendorData.language} onChange={handleInputChange} className="select select-bordered w-full mt-2" required>
          ...
          <div>
            ...
            <select name="location" value={vendorData.location} onChange={handleInputChange} className="select select-bordered w-full mt-2" required>
          ...
          <div>
            ...
            <select name="experience" value={vendorData.experience} onChange={handleInputChange} className="select select-bordered w-full mt-2" required>
